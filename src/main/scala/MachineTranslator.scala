...
class MachineTranslator(private[this] val conf: Config,
  ...
  private[this] def buildLexicon(conf: Config, lang1FilePath: String,
    ...
    val ibm2Lang1 = initializeIbmModel2(lang1FilePath, lang2FilePath, lang1ParamsReadFile, lang1ParamsWriteFile)
    ...
    val ibm2Lang2 = initializeIbmModel2(lang2FilePath, lang1FilePath, lang2ParamsReadFile, lang2ParamsWriteFile)
  ...
  private[this] def initializeIbmModel2(lang1FilePath: String, lang2FilePath: String,
                                        paramsReadFilePath: String, paramsWriteFilePath: String) = {

    val ibm2 =
      if (paramsReadFilePath.trim.isEmpty) {
        val ibm1 = IbmModel1(lang1FilePath, lang2FilePath, 5)
